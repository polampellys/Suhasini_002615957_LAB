...
public class DisplayJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(packageId, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 70, 80, 30));
        add(packageWt, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 80, 30));
        add(custId, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 130, 80, 30));
        add(productId1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 190, 80, 30));
        add(productName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, 80, 30));
        add(productPrice1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 80, 30));
